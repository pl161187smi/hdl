...
ad_ip_parameter sys_ps7 CONFIG.PCW_ACT_CAN_PERIPHERAL_FREQMHZ {100.000000} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_CAN0_CAN0_IO {MIO 14 .. 15} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_CAN_PERIPHERAL_DIVISOR0 {5} 
ad_ip_parameter sys_ps7 CONFIG.PCW_CAN_PERIPHERAL_DIVISOR1 {2} 
ad_ip_parameter sys_ps7 CONFIG.PCW_CAN_PERIPHERAL_FREQMHZ {100} 
ad_ip_parameter sys_ps7 CONFIG.PCW_CAN_PERIPHERAL_VALID {1} 
...
# proccessing system Clock Configuration
...
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_CS0_T_RC {2} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_CS0_T_TR {1} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_CS0_T_WC {2} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_CS1_T_RC {2} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_CS1_T_TR {1} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_CS1_T_WC {2} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_SRAM_CS0_T_RC {2} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_SRAM_CS0_T_TR {1} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_SRAM_CS0_T_WC {2} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_SRAM_CS1_T_RC {2} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_SRAM_CS1_T_TR {1} 
ad_ip_parameter sys_ps7 CONFIG.PCW_NOR_SRAM_CS1_T_WC {2} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.080} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY1 {0.063} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY2 {0.057} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY3 {0.068} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_0 {-0.047} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_1 {-0.025} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_2 {-0.006} 
ad_ip_parameter sys_ps7 CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {-0.017} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_SD0_GRP_WP_IO {MIO 47} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UART0_UART0_IO {<Select>} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.271} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.259} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {0.219} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {0.207} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_CLOCK_0_PACKAGE_LENGTH {54.563} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_CLOCK_1_PACKAGE_LENGTH {54.563} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_CLOCK_2_PACKAGE_LENGTH {54.563} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_CLOCK_3_PACKAGE_LENGTH {54.563} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_0_PACKAGE_LENGTH {101.239} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_1_PACKAGE_LENGTH {79.5025} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_2_PACKAGE_LENGTH {60.536} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_3_PACKAGE_LENGTH {71.7715} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_3_PROPOGATION_DELAY {160} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {0.229} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.250} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {0.121} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 {0.146} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQ_0_LENGTH_MM {0} 
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQ_0_PACKAGE_LENGTH {104.5365} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQ_1_PACKAGE_LENGTH {70.676} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQ_2_PACKAGE_LENGTH {59.1615} 
...
ad_ip_parameter sys_ps7 CONFIG.PCW_UIPARAM_DDR_DQ_3_PACKAGE_LENGTH {81.319} 
